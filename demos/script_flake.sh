...
# python3 src/demo.py --in_dir in/flake/ --out_dir out/ --forward flake --operation generate --fn 0.png --para_all 720.772 0.089 0.000 0.804 0.045 0.115 0.000 0.512 0.371 0.260 0.497 0.481 0 0 8.381
