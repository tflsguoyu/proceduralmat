...
def processing(tmp_dir, N):
    outputDir = tmp_dir
    inputDir = tmp_dir
    checkpoint = '../../../3_svbrdf/otherPaper/Deschaintre_egsr19/multiImage_code/checkpointTrained/'

    cmd = 'python ../../../3_svbrdf/otherPaper/Deschaintre_egsr19/multiImage_code/pixes2Material.py' \
        + ' --mode test' \
