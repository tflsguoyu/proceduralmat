...
PDSampler::PDSampler(unsigned _seed, float _radius, bool _isTiled, bool usesGrid) :
	m_rng(_seed),
	radius(_radius),
	isTiled(_isTiled)
{
...
DartThrowing::DartThrowing(unsigned seed, float radius, bool isTiled, int minMaxThrows, int maxThrowsMult) :
