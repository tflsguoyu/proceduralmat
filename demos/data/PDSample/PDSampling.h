...
public:
	PDSampler(unsigned seed, float radius, bool isTiled, bool usesGrid=true);
...
public:
	DartThrowing(unsigned seed, float radius, bool isTiled, int minMaxThrows, int maxThrowsMult);
